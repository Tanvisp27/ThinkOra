...
function CreateEscrow() {
    ...
    const [statusMssg, setStatusMssg] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const handleSubmit = async (e)=>{
        ...
        if (!window.ethereum) {
            setStatusMssg({
                type: 'error',
                text: "MetaMask not found. Please install MetaMask to use this app."
            });
            return;
        }
        try {
            ...
            const contract = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].Contract(ESCROW_ADDRESS, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$Escrow$2e$json__$28$json$29$__["default"].abi, signer);
            ...
            const parsedAmount = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].parseEther(amount);
            const tx = await contract.createEscrow(seller, durationInSeconds, {
                value: parsedAmount
            });
            setStatusMssg({
                type: 'success',
            ...
            setStatusMssg({
                type: 'error',
                text: error.reason || error.message || "Failed to create escrow."
            });
        } finally{
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    statusMssg && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: `p-4 rounded-lg text-sm font-medium ${statusMssg.type === 'error' ? 'bg-red-500/10 text-red-500 border border-red-500/20' : 'bg-emerald-500/10 text-emerald-500 border border-emerald-500/20'}`,
                        children: statusMssg.text
                    }, void 0, false, {
                        fileName: "[project]/src/app/create/page.tsx",
                        lineNumber: 83,
                        columnNumber: 21
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80cd47fc._.js.map