...
function Dashboard() {
                    ...
                    if (("TURBOPACK compile-time value", "object") !== 'undefined' && window.ethereum) {
                        try {
                            ...
                            if (accounts.length > 0) {
                                ...
                                fetchEscrows(accounts[0].address, provider);
                            } else {
                                setIsLoading(false);
                            }
                        } catch (error) {
    ...
    const fetchEscrows = async (userAddress, provider)=>{
        try {
            ...
            // Note: In a production app, we would use an indexer or backend for querying events to avoid heavy RPC calls.
            // For this demo, we can query the 'EscrowCreated' events. 
            // However, to make this purely standalone without worrying about block limits, we can iterate from 0 to nextTransactionId.
            // Let's implement the safer index-based approach for this demo since ID starts at 0.
            ...
            for(let i = 0; i < idCount; i++){
                ...
                const buyer = txData[0];
                const seller = txData[1];
                ...
                if (isBuyer || isSeller) {
                    fetchedEscrows.push({
                        ...
                        buyer,
                        seller,
                        amount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ethers$2f$lib$2e$esm$2f$ethers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__ethers$3e$__["ethers"].formatEther(txData[2]),
                        deadline: Number(txData[3]),
                        isCompleted: txData[4],
    ...
    const handleRelease = async (id)=>{
        ...
        try {
            ...
            setEscrows(escrows.map((e)=>e.id === id ? {
                    ...e,
                    isCompleted: true
                } : e));
        } catch (error) {
            console.error("Error releasing funds:", error);
            alert("Failed to release funds. See console for details.");
        } finally{
            setReleasingId(null);
        }
    };
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    lineNumber: 143,
                    columnNumber: 21
                }, this) : escrows.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "text-center py-20 bg-zinc-900/30 border border-white/5 rounded-2xl",
                    children: [
                    ...
                    children: escrows.map((escrow)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                !escrow.isCompleted && escrow.role === 'buyer' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "w-full flex justify-center items-center py-2.5 px-4 border border-transparent rounded-lg text-sm font-medium text-white bg-emerald-500/20 text-emerald-400 hover:bg-emerald-500/30 focus:outline-none transition-colors disabled:opacity-50",
...
_s(Dashboard, "W+3tMNPGaOVcMBmJJJoL88PHYbw=");
_c = Dashboard;
var _c;
...
//# sourceMappingURL=_4f66a75e._.js.map